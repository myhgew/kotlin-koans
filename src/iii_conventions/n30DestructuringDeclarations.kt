...
private operator fun MyDate.component1(): Int = this.year
private operator fun MyDate.component2(): Int = this.month
private operator fun MyDate.component3(): Int = this.dayOfMonth
